...
const ImageDraw: FC<ImageProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      {
        isLogin ? <img src={url} style={{...styles}} alt=''/> : <div style={{borderStyle: "solid",
        borderWidth: "1px",
        ...styles,}}><input name='未选择' style={{marginTop: "80px",marginLeft: "20px"}} type="file" accept="image/gif,image/jpeg,image/jpg,image/png" onChange={e => {change(e)}}></input></div>
      }
    </div>
  )
}
